...
class LungDensitySegmentationTest(ScriptedLoadableModuleTest):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_LungDensitySegmentation1()

  def test_LungDensitySegmentation1(self):
    ...
    logic = LungDensitySegmentationLogic()
